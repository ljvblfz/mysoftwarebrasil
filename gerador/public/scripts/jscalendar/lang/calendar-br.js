...
"\n\n" +
"Seleção de data:\n" +
"- Use botões \xab, \xbb para selecionar o ano\n" +
"- Use botões " + String.fromCharCode(0x2039) + ", " + String.fromCharCode(0x203a) + "  para selecionar meses\n" +
"- Segure o botão do mouse em qualquer uma das opções acima para seleção rápida";
