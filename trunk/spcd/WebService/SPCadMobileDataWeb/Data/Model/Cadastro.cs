...
namespace SPCadMobileDataWeb.Data.Model
{
    ...
    public class Cadastro:AuditoriaSuper
    {
        ...
        //TODO: Alterado para resolver problema de re-importação. Desfazer.
        //[PersistenceProperty("ID_CADAST", PersistenceParameterType.Key)]
        [PersistenceProperty("ID_CADAST_TEMP")]
        ...
        [PersistenceProperty("NUM_MATRIC", PersistenceParameterType.Key)]
        ...
        public string VetorOcorrencia { get; set; }
