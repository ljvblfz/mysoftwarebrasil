...
namespace SPCadMobileData.Data.DAL
{
    public class DaoFactory
    {
        ...
        public static Dao<CadastroAuxiliar> getCadastroAuxiliar()
        {
            return new Dao<CadastroAuxiliar>();
        }
        ...
        public static Dao<AuxConsCadast> getAuxConsCadast()
        {
            return new Dao<AuxConsCadast>();
        }
    }
}
