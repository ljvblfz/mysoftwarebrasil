                    ...
                    if (obj != waitFailed)
                    {
                        switch (obj)
                        {
                            case 0:
                                ...
                                break;
                            case 1:
                                ThreadSafe.FireEvent(deviceStateChanged, this, new DeviceStateChangedEventArgs(GetDeviceState()));
                                break;
                            case 2:
                                ThreadSafe.FireEvent(locationChanged, this, new LocationChangedEventArgs(GetPosition()));
                                break;
                        }
                    }
                }
