...
Create table Endereco (
	...
	idBairro Int COMMENT 'Bairro',
 Primary Key (idEndereco)) ENGINE = MyISAM;

Create table Perfil (
	idSexo Int COMMENT 'Sexo',
	idOlho Int COMMENT 'Olho',
	idCabelo Int COMMENT 'Cabelo',
	idEtinia Int COMMENT 'Etinia',
	idEstadoCivil Int COMMENT 'Estado civil',
