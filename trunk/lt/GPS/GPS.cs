...
namespace GFiscMobile.GPS
{
    ...
    public class Gps
    {
        ...
        // priority of the GPS device thread
        System.Threading.ThreadPriority gpsThreadPriority = System.Threading.ThreadPriority.Normal;

        // Tempo de espera entre duas execuções do thread
        ...
        /// </summary>
        /// <param name="priority">The GPS thread priority.</param>
        /// <param name="waiting">The GPS thread wait time.</param>
        public Gps(System.Threading.ThreadPriority priority, int waiting)
        {
            gpsThreadPriority = priority;
            tempoEspera = waiting;
        }
        ...
        public GpsPosition GetPosition(TimeSpan maxAge)
        {
            ...
            try
            {
                if (Opened)
                {
                    ...
                    IntPtr ptr = Utils.LocalAlloc(Marshal.SizeOf(typeof(GpsPosition))+80);
                    ...
                    else if (result == 87)
                    {
                        ...
                        gpsPosition = new GpsPosition();
                        gpsPosition.dwVersion = 1;
                        gpsPosition.dwSize = 376;//Marshal.SizeOf(typeof(GpsPosition));

                        // Marshal our data to the native pointer we
                        Marshal.StructureToPtr(gpsPosition, ptr, false);
        ...
        private void CreateGpsEventThread()
        {
            ...
            if (gpsEventThread == null && gpsHandle != IntPtr.Zero)
            {
                ...
                gpsEventThread.Priority = gpsThreadPriority;
