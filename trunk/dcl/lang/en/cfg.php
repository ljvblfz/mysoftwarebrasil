<?php
	define('STR_CFG_TITLE', "DCL Configuraчуo");
	define('STR_CFG_DESC', "Esta tela permitirс que vocъ definir as configuraчѕes padrуo e comportamentos em DCL.");
	define('STR_CFG_SYSTEMTITLE', "Configuraчуo do sistema");
	define('STR_CFG_DATEFORMAT', "Formato de data de exibiчуo");
	...
	define('STR_CFG_TIMESTAMPFORMAT', "Timestamp Formato de exibiчуo");
