...
{
    public class FaturaServicoDAO : BaseDAO<FaturaServico>
    {
        public List<FaturaServico> Lista()
        {
            string sql = @"
                            SELECT DISTINCT
                                *
        ...
        public List<FaturaServico> Importar(int grupo, int rotaIni, int rotaFim, DateTime referencia)
        {
            string sql = @"
