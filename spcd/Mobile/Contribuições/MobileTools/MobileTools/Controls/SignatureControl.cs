...
namespace MobileTools.Controls
{
	public class SignatureControl : Control
	{
		...
		public void Save(Stream stream, ImageFormat format)
		{
            ...
            grp.DrawImage(BackGroundImage, new Rectangle(0, 0, BackGroundImage.Width, BackGroundImage.Height), new Rectangle(0, 0, BackGroundImage.Width, BackGroundImage.Height), GraphicsUnit.Pixel);

            bmp.Save(stream, format);
            bmp.Dispose();

            //BackGroundImage.Save(stream, ImageFormat.Jpeg);
			//SaveToFile(this, stream);	
		}
		...
		private void SaveToFile(Control ctl, Stream stream)
		{
			IntPtr hDC;
			if ( ctl != null )
			{
