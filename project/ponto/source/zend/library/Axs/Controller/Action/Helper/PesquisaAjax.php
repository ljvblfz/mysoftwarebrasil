 ...
 * @package safciweb
 * @version $Id: PesquisaAjax.php,v 1.1 2009/03/25 18:41:50 delano Exp $ 
 */
...
* @access public 
*/
class Axs_Controller_Action_Helper_PesquisaAjax extends Zend_Controller_Action_Helper_Abstract {
    /**
    ...
    */
    ...
    /**
     * SQL gerada para a consulta na pesquisa
     * 
     * @name $sql 
     * @access $having
     * @var string
    ...
    /**
     * Retorna a SQL gerada para pesquisa.
     * 
     * @name getSQL 
     * @access public
     * @return string sql SQL gerada para pesquisa.
     */
    ...
    * array('nome_do_campo_a_ser_atualizado_na_tela' =>'nome_do_campo_no_banco');
    * 
    * 
    ...
    * @param string having
    * ex.: "nome_do_campo1 > 0 and nome_do_campo2 = 2 or nome_do_campo3 in (0,1,2) and .. etc"; 
    * @access public 
    * @return void 
    */
    ...
    protected function realizaConsulta()
    {
        ...
        */
        if (!$page && empty($orderBy)) {
            //decodifica o utf8 vindo do ajax
        ...
        $sql = "SELECT COUNT(*) as total from (" . $this->sql . ") tab";
        try {
