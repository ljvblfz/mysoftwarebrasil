<?php /* Smarty version 2.6.2, created on 2011-03-01 14:45:32
         compiled from htmlTableProject.tpl */ ?>
<?php require_once(SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'dcl_select_status', 'htmlTableProject.tpl', 54, false),array('function', 'dcl_select_personnel', 'htmlTableProject.tpl', 55, false),array('modifier', 'escape', 'htmlTableProject.tpl', 56, false),array('modifier', 'count', 'htmlTableProject.tpl', 75, false),)), $this); ?>
<!-- $Id: htmlTableProject.tpl 31 2007-01-08 03:19:06Z mdean $ -->
...
" />
		<span><label for="filterStatus"><?php echo @constant('STR_PRJ_STATUS'); ?>
:</label> <?php echo smarty_function_dcl_select_status(array('default' => $this->_tpl_vars['VAL_FILTERSTATUS'],'name' => 'filterStatus','allowHideOrOnlyClosed' => 'Y'), $this);?>
		...
		<span><label for="filterReportto"><?php echo @constant('STR_PRJ_LEAD'); ?>
:</label> <?php echo smarty_function_dcl_select_personnel(array('default' => $this->_tpl_vars['VAL_FILTERREPORTTO'],'name' => 'filterReportto'), $this);?>
		...
		<span><label for="filterReportto"><?php echo @constant('STR_PRJ_NAME'); ?>
:</label> <input type="text" size="15" maxlength="100" name="filterName" id="filterName" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['VAL_FILTERNAME'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
"></span>
...
$this->_sections['item']['last']       = ($this->_sections['item']['iteration'] == $this->_sections['item']['total']);
?>
		<?php if (! in_array ( $this->_sections['item']['index'] , $this->_tpl_vars['groups'] )): ?>
			<td class="<?php echo $this->_tpl_vars['columns'][$this->_sections['item']['index']]['type']; ?>
">
			...
			<?php endif; ?>
			<?php if ($this->_sections['item']['last']): ?>
			<td>
				<a href="<?php echo $this->_tpl_vars['URL_MAIN_PHP']; ?>
?menuAction=boProjects.viewproject&project=<?php echo $this->_tpl_vars['records'][$this->_sections['row']['index']][0]; ?>
">Detail</a>
				&nbsp;|&nbsp;<a href="<?php echo $this->_tpl_vars['URL_MAIN_PHP']; ?>
?menuAction=boProjects.showtree&project=<?php echo $this->_tpl_vars['records'][$this->_sections['row']['index']][0]; ?>
">Tree</a>
				<?php if ($this->_tpl_vars['VAL_WIKIUSED']): ?>&nbsp;|&nbsp;<a href="<?php echo $this->_tpl_vars['URL_MAIN_PHP']; ?>
?menuAction=boProjects.viewproject&project=<?php echo $this->_tpl_vars['records'][$this->_sections['row']['index']][0]; ?>
"><?php echo @constant('STR_CMMN_WIKI'); ?>
</a><?php endif; ?>
			</td>
			<?php endif; ?>
			</td>
