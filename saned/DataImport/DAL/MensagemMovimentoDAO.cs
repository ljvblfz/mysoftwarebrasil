...
{
    public class MensagemMovimentoDAO : BaseDAO<MensagemMovimento>
    {
        public List<MensagemMovimento> Lista()
        {
            string sql = @"
                            SELECT DISTINCT
                                *
		...
		public List<MensagemMovimento> Importar(int grupo,int rotaIni,int rotaFim)
        {
            List<MensagemMovimento> lista = new List<MensagemMovimento>();
            string sql = @"
                             SELECT DISTINCT
                          ...
                          ";
            lista = CurrentPersistenceObject.LoadData(sql, new GDAParameter("?Grupo", grupo), new GDAParameter("?rotaInicial", rotaIni), new GDAParameter("?rotaFinal", rotaFim));
            return lista;
        }
