...
{
    public class FaturaCategoriaDAO : BaseDAO<FaturaCategoria>
    {
        public List<FaturaCategoria> Lista()
        {
            string sql = @"
                            SELECT DISTINCT
                                *
				            FROM ONP_FATURA_CATEGORIA
                         ";
            return CurrentPersistenceObject.LoadData(sql);
        }

        public List<FaturaCategoria> Importar(int grupo, int rotaIni, int rotaFim, DateTime referencia)
        {
            string sql = @"
